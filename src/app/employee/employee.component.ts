...
export class EmployeeComponent {
  ...
  filter(){
    //alert(this.role);
    this.employees=this.employees.fliter((employee:any)=>employee.role==this.role)
  }

  //search Filter
  term:string='';
  search(){
    this.employees=this.employees.fliter((employee:any)=>employee.name.includes(this.term));
  }
